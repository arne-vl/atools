...
echo "Installing..."
sudo mv /tmp/atools /usr/bin/atools
...
# https://atools.arnevanlooveren.be/docs#construct
...
echo "Checkout the documentation for more information:"
echo "https://atools.arnevanlooveren.be/docs"
